...
if __name__ == '__main__':
    ...
    ### Revised ###
    all_img_folder = os.path.join(img_base_path, f"mast3r_{n_views}_views/init_test_pose/images")
    ...
    ### Revised ###
    train_pts_all_path = os.path.join(img_base_path, f"mast3r_{n_views}_views", "sparse/0", "pts_4_3dgs_all.npy")
    ...
    if args.focal_avg:
        ...
        ### Revised ###
        focal_path = os.path.join(img_base_path, f"mast3r_{n_views}_views", "sparse/0", "focal.npy")
